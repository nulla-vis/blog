...
const submitNewPost = () => {
    ...
    fetch(API_URL, {
        ...
        //because we using json database and its hard to access for read and wtrite at the same time
        //sometimes after posting, refreshing there will be error so we set time out
        setTimeout(()=>{
