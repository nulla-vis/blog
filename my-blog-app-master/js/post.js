...
const API_URL = "http://localhost:3000/api/posts/"; //this URL give all the post, so we cut it to post by id
...
const getPostIdParam = () => { //create function to catch the ID
...
const getPost = () => {
    // CODE GOES HERE
    const postId = getPostIdParam(); //we get the postID
...
const buildPost = (data) => {
    ...
    document.querySelector(".post-data").innerHTML = PostData;
}
